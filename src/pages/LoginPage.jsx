      ...
      <div className="w-full flex flex-col lg:flex-row justify-between  rounded">
        ...
        <div className="lg:w-1/2 px-8 py-6 bg-white bg-blu bg-opacity-20 shadow-md rounded-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-[#ed4286] text-white py-2 px-4 rounded-md hover:bg-[#c24977] transition duration-300">
              Login
            </button>
          </form>
          <p className="text-center mt-4 mb-4">
            Don't have an account?{" "}
            <Link to='registration' className="text-[#ed4286]">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
