          ...
          <div className="col-span-3 mr-4 2xl:mr-6">
            <div
              className={`grid grid-cols-3 gap-4 ${
                bloodO2 || bloodHighPressure || bloodSugar
                  ? ""
                  : "min-h-[150px] 2xl:min-h-[200px]"
              }`}
            >
              <div
                className={` px-3 py-5 2xl:px-5 2xl:py-7 bg-white rounded-xl shadow-xl border border-[#E8E7E7] ${
                  oxygenCondition === "High" || oxygenCondition === "Low"
              ...
              <div
                className={` px-3 py-5 2xl:px-5 2xl:py-7 bg-white rounded-xl shadow-xl border border-[#E8E7E7] ${
                  sugarConditon === "High" || sugarConditon === "Low"
                    ? "border-[1px] border-red-500"
                    : ""
                }`}
              >
                    ...
                    <div className="grid grid-cols-3 ">
                      <div className="col-span-1 border-r border-r-pink-500">
                        <div className="flex justify-center items-center border-b  bg-[#c7b3d4]">
                          <h1 className="text-center font-medium  py-2">
                            Morning
                          </h1>
                        </div>
                        <div className="p-5">
